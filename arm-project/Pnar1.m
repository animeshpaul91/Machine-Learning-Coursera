function  [Rules, FreqPItemsets, FreqNItemsets]  = Pnar1( )
...
[Rules, FreqPItemsets, FreqNItemsets] = FindRulesPnartraditional1(Dataset, minSup, dms, mc, nRules, sortFlag, fname);
