function  [Rules, FreqPItemsets, FreqNItemsets]  = Pnar_improved1( )
...
sortFlag = 1;
fname = 'PnarRules1';
[Rules, FreqPItemsets, FreqNItemsets] = FindRulesPnar(Dataset1, minSup, dms, P_mc, N_mc, mincorr, nRules, sortFlag, fname);
% FreqPItemsets{1}(1:end)
% FreqPItemsets{1}(1:end)
