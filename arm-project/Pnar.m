function  [Rules, FreqPItemsets, FreqNItemsets]  = Pnar( )
...
[Rules, FreqPItemsets, FreqNItemsets] = FindRulesPnartraditional(Dataset, minSup, dms, mc, dmc, nRules, sortFlag, fname);
